...
- Name: qa-suite.spec.js >> 1. Auth & Onboarding >> 1.1 Landing page renders and CTA works
- Location: e2e\qa-suite.spec.js:9:3
...
Locator: locator('a[href="/auth"], button:has-text("Get Started"), a:has-text("Get Started")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('a[href="/auth"], button:has-text("Get Started"), a:has-text("Get Started")').first()
...
- paragraph: "Failed to fetch dynamically imported module: http://localhost:3000/src/pages/Landing.jsx"
