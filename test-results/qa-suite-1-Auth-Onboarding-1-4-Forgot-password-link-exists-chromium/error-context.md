...
- Name: qa-suite.spec.js >> 1. Auth & Onboarding >> 1.4 Forgot password link exists
- Location: e2e\qa-suite.spec.js:33:3
...
Locator: locator('text=/forgot/i').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('text=/forgot/i').first()
