...
export default function NotFound() {
  return (
    <div style={{display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'60vh',color:'var(--text-tertiary)'}}>
      <div aria-hidden="true" style={{fontSize:72,marginBottom:16}}>🔍</div>
      ...
      <div style={{display:'flex',gap:12}}>
        ...
        <button className="btn btn-outline" onClick={() => openSupportWhatsApp({ page: '404', issue: 'Broken Link' })}><span aria-hidden="true">🆘</span> Contact Support</button>
      </div>
    </div>
  )
}
